...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 main_container">
            <ul class="nav nav-tabs doc-tab" id="file-tab">
                <li class="active"><a href="/examdata/zhenti" {{-- onclick="chtab('1')" --}}>专业课真题</a></li>
                <li><a href="/examdata/data" {{-- onclick="chtab('-1')" --}}>专业课资料</a></li>
                <div class="right " style="float: right; margin: 0 5px 0 5px; line-height: 44px">
                    ...
                    @else
                        <button disabled="disabled" id="uploadbtn" type="button" class="btn btn-link"
                                data-toggle="modal"
                                data-target="#upload-modal" value="1">登陆后可上传真题
                        </button>
                    @endif
                </div>
            </ul>
